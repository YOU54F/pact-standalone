...
Ruby is not required on the host platform, Ruby 3.4.4 is provided in the distributable.

| OS     | Ruby      | Architecture   | Supported |
| -------| -------   | ------------   | --------- |
| MacOS  | 3.4.4     | x86_64         | ✅        |
| MacOS  | 3.4.4     | aarch64 (arm64)| ✅        |
| Linux  | 3.4.4     | x86_64         | ✅        |
| Linux  | 3.4.4     | aarch64 (arm64)| ✅        |
| Windows| 3.4.4     | x86_64         | ✅        |
| Windows| 3.4.4     | x86            | ✅        |
| Windows| 3.4.4     | aarch64 (arm64)| 🚧        |
